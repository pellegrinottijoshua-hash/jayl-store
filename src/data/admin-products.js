...
export const adminProducts = [
  ...
  },
  {
    ...
    "price": 2399,
    "currency": "eur",
    "description": "Alakazam, the cerebral Pokémon known for its unparalleled intelligence, graces this Gildan premium tee with a striking over-the-heart print that captures its sharp, psychic essence. With its vibrant colors and intricate details, this shirt reflects Alakazam's unique blend of wisdom and whimsy, making it a standout piece for any wardrobe. The direct-to-garment print quality ensures that the artwork remains bold and eye-catching, wash after wash. This t-shirt makes an exceptional gift for those who appreciate the nuances of their favorite Pokémon and value high-quality apparel.",
    "altText": "Alakazam conjuring energy with a focused gaze, depicted in retro 90s anime style on a JAYL premium tee.",
    "details": [
      "Gildan 64000 Softstyle — premium ring-spun cotton tee",
      "Fabrication: Solid colors 100% ring-spun cotton; Sport Grey 90% cotton / 10% polyester; Heather colors 35% cotton / 65% polyester; Graphite Heather 65% cotton / 35% polyester",
      "Lightweight 4.5 oz/yd² (153 g/m²) with a soft, modern semi-fitted cut",
    ...
    "longTailKeywords": [
      "buy alakazam t-shirt online",
      "cool pokemon shirts for fans",
      "pokemon apparel for collectors",
      "gildan premium t-shirt designs",
      "unique gifts for pokemon lovers",
      "retro anime style t-shirts",
      "direct-to-garment print shirts",
      "fashionable pokemon fan gear",
      "high-quality pokemon apparel",
      "gift ideas for anime fans"
    ],
    "hashtags": "#alakazam #pokemon #artapparel #anime #gildan #fashion #coolpokemon #fanart #collectibles #tshirt #streetwear #geekfashion #nerdlife #pokemontshirt #animeart #90sstyle #graphictee #uniqueapparel #premiumquality #giftideas #pokemongifts #retroanime #stylish #artwear #fashionstatement #pokemontime #vintageanime #fashiongoals #animefans #trendsetter",
    "instagramCaption": "Ready to outsmart the competition? Grab this Alakazam tee and show off your psychic prowess. #alakazam #pokemon #fashion",
    "pinterestCaption": "Explore our Alakazam t-shirt, showcasing vibrant retro art that captures the intellect of this iconic Pokémon. A must-have for any fan looking to elevate their style in comfort.",
    "seoTitle": "Alakazam T-Shirt | Cool Pokémon Apparel | Unique Gift Idea",
    "variants": [
      {
