...
export const adminProducts = [
  ...
  },
  {
    ...
    "price": 2399,
    "currency": "eur",
    "description": "Gengar embodies the playful side of spooky, always ready to lurk in the shadows with a mischievous grin. This premium Gildan tee, featuring high-quality DTG print, captures Gengar's vibrant purple hue and cheeky demeanor, making it a standout piece in any wardrobe. Whether you're out with friends or simply lounging at home, this shirt brings a fun twist to your style. It also makes an excellent gift for those who appreciate Gengar's unique charm and playful essence, allowing them to carry a piece of their favorite Pokémon wherever they go.",
    "altText": "Gengar grinning mischievously with its signature purple color in small chest print on a premium JAYL tee.",
    "details": [
      "Gildan 64000 Softstyle — premium ring-spun cotton tee",
      "Fabrication: Solid colors 100% ring-spun cotton; Sport Grey 90% cotton / 10% polyester; Heather colors 35% cotton / 65% polyester; Graphite Heather 65% cotton / 35% polyester",
      "Lightweight 4.5 oz/yd² (153 g/m²) with a soft, modern semi-fitted cut",
    ...
    "longTailKeywords": [
      "gengar t-shirt for fans",
      "cool pokemon apparel online",
      "unique pokemon gifts",
      "gengar graphic tee",
      "stylish pokemon tops",
      "Gildan tees with print",
      "fun shirts for anime lovers",
      "premium pokemon clothing",
      "anime character t-shirts",
      "vibrant pokemon fan gear"
    ],
    "hashtags": "#gengar #pokemon #gengarshirt #coolpokemon #pokemonfan #animeshirt #gildantee #dtgprint #pokemonapparel #gengarart #uniquegift #funshirt #coolapparel #otaku #anime #nerdlife #geekstyle #kawaii #artwear #streetwear #fashion #tshirt #graphictee #limitededition #geekygear #popculture #animefashion #fanart #retrofashion #animecommunity #shopnow",
    "instagramCaption": "Bring some shadowy vibes to your wardrobe with our Cool Gengar T-Shirt. It’s the ultimate blend of spooky and stylish! Grab yours now and let Gengar’s mischief shine! #gengar #coolpokemon #pokemonfan",
    "pinterestCaption": "Get ready to embrace your inner mischief with this Cool Gengar T-Shirt. Made with premium Gildan fabric and high-quality print, it's a must-have for any Pokémon fan. Don't miss out on this unique addition to your collection.",
    "seoTitle": "Cool Gengar T-Shirt | Spooky Vibes & Fan Gift | Cool Pokémon",
    "variants": [
      {
